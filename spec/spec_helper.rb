...
if ENV['CODE_COVERAGE']
  ...
  SimpleCov.start do
    ...
    add_group 'Lib', 'lib'
    add_group 'Services', 'lib/planning_poker/services'
    add_group 'Entities', 'lib/planning_poker/entities'
    add_group 'Repositories', 'lib/planning_poker/repositories'
    add_group 'Validators', 'lib/planning_poker/validator'
  end
end
